...
public static class ApplicationStart
{
    public static void InitAuthorizeData(this IApplicationBuilder application)
    {
        Task.Run(() =>
        {
            ...
            var authorizeEvent = new AuthorizeEvent(permissionService.GetAuthorizeDataRuleList().Result,
                                                    permissionService.GetAuthorizePermissionList().Result);
            ...
            var customHeader = new Dictionary<string, string>
            {
                ...
                { ClaimTypes.NameIdentifier, nameof(IdentityType.ManagerUser) },
            };
            ...
            eventBus.PublishAsync(authorizeEvent);
        });
    }
}