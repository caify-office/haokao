...
public class LiveProductPackageRepository : Repository<LiveProductPackage>, ILiveProductPackageRepository
{
    public override async Task<List<LiveProductPackage>> GetByQueryAsync(QueryBase<LiveProductPackage> query)
    {
