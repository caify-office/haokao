...
public static class UpdateClientViewModelConvertHelper
{
    public static UpdateAccessClientCommand ConvertToCommand(this UpdateClientViewModel model)
    {
        ...
        var command = new UpdateAccessClientCommand(
            model.Id,
            model.Enabled,
            model.ClientId,
            model.ProtocolType,
