...
public class BasalPermission : PermissionBase
{
    ...
    /// <summary>
    /// 对应用户ID或角色ID (现在对应是Role的Id)
    /// </summary>
    public Guid AppliedId { get; set; }

    /// <summary>
    /// 对应功能模块的ID (对应ServicePermission的ServiceId)
    /// </summary>
    ...
    // public override Permission AllowMask
    // {
    //     get => base.AllowMask;
    //     set => base.AllowMask = value;
    // }
    //
    // public override Permission DenyMask
    // {
    //     get => base.DenyMask;
    //     set => base.DenyMask = value;
    // }
