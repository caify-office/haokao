...
{
    public partial class initBasicServiceDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    Name = table.Column<string>(type: "nvarchar(30)", nullable: true, comment: "角色名称"),
                    Desc = table.Column<string>(type: "nvarchar(200)", nullable: true, comment: "角色描述"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tag = table.Column<string>(type: "varchar(50)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Order = table.Column<int>(type: "int", nullable: false),
                    FuncModule = table.Column<long>(type: "bigint", nullable: false),
                    OtherParams = table.Column<string>(type: "text", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<string>(type: "varchar(36)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TenantName = table.Column<string>(type: "varchar(500)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FieldValue = table.Column<string>(type: "text", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FieldValueText = table.Column<string>(type: "text", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ExpressionType = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "AuthorizeType", "ContactNumber", "CreateTime", "CreatorId", "CreatorName", "IsInitData", "OtherId", "State", "TenantId", "TenantName", "UserAccount", "UserName", "UserPassword", "UserType" },
                values: new object[] { new Guid("58205e0e-1552-4282-bedc-a92d0afb37df"), 0, null, new DateTime(2023, 2, 24, 11, 53, 23, 547, DateTimeKind.Local).AddTicks(2290), "58205e0e-1552-4282-bedc-a92d0afb37df", null, 1ul, new Guid("00000000-0000-0000-0000-000000000000"), 0, "00000000-0000-0000-0000-000000000000", "系统管理", "systemsuperadmin", "系统管理员", "21232F297A57A5A743894A0E4A801FC3", 1 });

            migrationBuilder.CreateIndex(
                name: "IX_BasalPermission_AppliedId",
                table: "BasalPermission",
                column: "AppliedId");

            migrationBuilder.CreateIndex(
                name: "IX_BasalPermission_AppliedObjectId",
                table: "BasalPermission",
                column: "AppliedObjectId");

            migrationBuilder.CreateIndex(
                name: "IX_BasalPermission_AppliedObjectType",
                table: "BasalPermission",
                column: "AppliedObjectType");

            migrationBuilder.CreateIndex(
                name: "IX_BasalPermission_ValidateObjectId",
                table: "BasalPermission",
                column: "ValidateObjectId");

            migrationBuilder.CreateIndex(
                name: "IX_BasalPermission_ValidateObjectType",
                table: "BasalPermission",
                column: "ValidateObjectType");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_User_UserAccount_TenantId",
                table: "User",
                columns: new[] { "UserAccount", "TenantId" },
                unique: true);
