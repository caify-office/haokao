...
public static class QuestionCollectionCacheManager
{
    private static Type EntityType => typeof(QuestionCollection);

    private static string EntityTypeName => nameof(QuestionCollection).ToLowerInvariant();
