...
[AllowAnonymous]
public class LecturerWeChatService(ILecturerWebService service) : ILecturerWeChatService
{
    private readonly ILecturerWebService _service = service ?? throw new ArgumentNullException(nameof(service));
