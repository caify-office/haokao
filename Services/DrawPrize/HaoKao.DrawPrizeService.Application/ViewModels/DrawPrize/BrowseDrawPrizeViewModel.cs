...
public class BrowseDrawPrizeViewModel : IDto
{
    ...
    /// 中奖人数
    /// </summary>
    public int WinningPrizeRecordsCount
    {
        get
        {
            return DrawPrizeRecords.Count(x => !string.IsNullOrEmpty(x.PrizeName));
        }
    }
    ...
    /// 抽奖人数
    /// </summary>
    public int DrawPrizeRecordsCount
    {
        get
        {
            return DrawPrizeRecords.Count();
        }
    }
    /// <summary>
    /// 抽奖记录
