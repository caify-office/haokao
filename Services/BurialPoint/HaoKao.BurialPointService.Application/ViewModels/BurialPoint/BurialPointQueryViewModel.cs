...
[AutoMapFrom(typeof(BurialPointQuery))]
[AutoMapTo(typeof(BurialPointQuery))]
public class BurialPointQueryViewModel : QueryDtoBase<BurialPointQueryListViewModel>
{
    /// <summary>
    /// 名称
    /// </summary>
...
[AutoMapTo(typeof(Domain.Entities.BurialPoint))]
public class BurialPointQueryListViewModel : IDto
{
