...
public class SupervisorClassWebService : ISupervisorClassWebService
{
    #region 初始参数

    private readonly ISupervisorClassService _service;
    ...
    /// 构造函数
    /// </summary>
    public SupervisorClassWebService( ISupervisorClassService service)
    {
