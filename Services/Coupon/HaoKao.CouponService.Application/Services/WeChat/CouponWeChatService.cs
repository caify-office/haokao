...
using HaoKao.Common;
using HaoKao.CouponService.Application.Services.Web;
...
public class CouponWeChatService(ICouponWebService service) : ICouponWeChatService
{
    private readonly ICouponWebService _service = service ?? throw new ArgumentNullException(nameof(service));
