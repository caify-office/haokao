...
namespace HaoKao.CourseService.WebApi;
...
public class Startup(IConfiguration configuration, IWebHostEnvironment webHostEnvironment):IGirvsStartup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddControllersWithAuthorizePermissionFilter(options => options.Filters.Add<GirvsModelStateInvalidFilter>()).AddJsonOptions(options =>
        {
        ...
        var types = typeFinder.FindOfType<IStorageHandler>();
